...
function IndexPage() {
  return (
    <main className="min-h-screen px-6 py-18 grid place-items-center">
      <Seo title="Frontend Mentor: Testimonials grid section" />
      <h1 className="sr-only">Testimonials list</h1>
      <TestimonialsGrid className="max-w-container">
        <TestimonialCard
          avatar={imageDaniel}
        ...
        >
          ...
          only say wonderful things about the program. The entire curriculum and staff did not disappoint. They were
